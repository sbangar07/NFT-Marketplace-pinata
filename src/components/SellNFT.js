...
export default function SellNFT(props) {
  ...
  async function uploadMetadataToIPFS() {
    ...
    try {
      ...
      console.log("error uploading JSON metadata:", e.message);
    }
  }
  ...
  async function listNFT(e) {
    ...
    try {
      ...
      // Here Database insert record will happpend for newly inserted tockens/NFT
      //   axios
      //     .get("/api/insetNftdetails", {
      //       params: {
      //         product: nftJSON,
      //       },
      //     })
      ...
      alert("Upload error" + e.data.message);
    }
  }
